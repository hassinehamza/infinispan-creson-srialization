...
import org.infinispan.hotrod.creson.serialization.RemoteQuery;
...
public class OperationsFactory implements HotRodConstants {
    ...
    public org.infinispan.hotrod.creson.serialization.QueryOperation newCresonQueryOperation(RemoteQuery remoteQuery) {
        return new org.infinispan.hotrod.creson.serialization.QueryOperation(
                codec, transportFactory, cacheNameBytes, topologyId, flags(), clientIntelligence, remoteQuery
        );
    }
